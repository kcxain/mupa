...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://huggingface.co/collections/kcxain/musl-680e272b471da12ec072d486">
    <img 
        src="https://img.shields.io/badge/MuSL-Hugging%20Face-orange?logo=huggingface&logoColor=yellow" 
        alt="Collections on Hugging Face"
    />
  </a>
</p>

This is the public release of the official implementation for the paper [Mutual-Supervised Learning for Sequential-to-Parallel Code Translation](https://arxiv.org/abs/2506.11153).
...
### Main results
<p align="center">
  <img src="./figures/results.png" alt="Overview" width="80%" />
</p>
